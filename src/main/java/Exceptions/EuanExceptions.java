...
public class EuanExceptions extends Exception{
    ...
    public void isRubbish()
    {
        ...
        System.out.println ("#3: 'Event': refers to a task that refers to a meeting/appointment that specifies a timeframe. For example 'event project meeting /from 02:00/to 17:00'. " +
        ...
        System.out.println ("#7: 'Find': refers to an action to find task containing a common word. For example find book.");
